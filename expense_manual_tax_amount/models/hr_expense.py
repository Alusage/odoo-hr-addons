        ...
        for expense in self:
            ...
            if expense.force_tax_amount:
                taxes["total_excluded"] = (
                    expense.total_amount - expense.manual_tax_amount
                )
            ...
            if expense.force_tax_amount:
                ...
                move_line_tax_values = {
                    ...
                    "amount_currency": amount_currency,
                    "account_id": (
                        taxes["taxes"][0]["account_id"]
                        if taxes["taxes"]
                        else move_line_src["account_id"]
                    ),
                    "expense_id": expense.id,
                    "partner_id": partner_id,
                    "tax_ids": [(6, 0, expense.tax_ids.ids)],
                ...
                for tax in taxes["taxes"]:
                    ...
                    move_line_tax_values = {
                        ...
                        "currency_id": expense.currency_id.id,
                        "analytic_account_id": (
                            expense.analytic_account_id.id if tax["analytic"] else False
                        ),
                        "analytic_tag_ids": (
